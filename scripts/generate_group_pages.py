...
GROUP_COLORS = {
    ...
    'kpop_bts':         ('#6d28d9', '#c4b5fd'),
    'kpop_straykids':   ('#1e293b', '#94a3b8'),
    'kpop_blackpink':   ('#be185d', '#f9a8d4'),
    'kpop_lesserafim':  ('#b45309', '#fde68a'),
    'kpop_aespa':       ('#0f766e', '#5eead4'),
    'kpop_ive':         ('#be123c', '#fda4af'),
    'kpop_newjeans':    ('#1d4ed8', '#93c5fd'),
    'west':             ('#2563eb', '#93c5fd'),
