...
tags:
  ...
  - "居酒屋"
ordered_items:
  - "{'name': 'フォアグラとトリュフの土鍋ご飯（みんなでシェア）'}"
  - "{'name': '蟹といくらの土鍋ご飯（みんなでシェア）'}"
  - "{'name': '大トロ鰯原始焼き（みんなでシェア）'}"
  - "{'name': '炉ばた名物大海老原始焼き（みんなでシェア）'}"
  - "{'name': '希少黒毛和牛東京ビーフミスジの炭火焼き（みんなでシェア）'}"
  - "{'name': '厚切り牛タン炭火炙り（みんなでシェア）'}"
  - "{'name': '白レバ刺し（みんなでシェア）'}"
  - "{'name': 'ホワイトマッシュルームと水菜のサラダ（みんなでシェア）'}"
