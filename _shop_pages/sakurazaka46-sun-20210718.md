...
description: "そこ曲がったら、櫻坂？で紹介された「フルーツサンド屋SUN」（東京都台東区）。食べログ3.09点。推し活グルメ巡礼スポット。"
...
source_type: "tv"
business_hours: "火・水・木・金・土・日 11:30 - 18:00 月 定休日 ■ 定休日火曜日(隔週) 営業時間・定休日は変更となる場合がございますので、ご来店前に店舗にご確認ください。"
